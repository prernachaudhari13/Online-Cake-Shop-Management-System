...
include("header.php"); 
		...
		$sql ="UPDATE user SET password='$newpswd' WHERE password='$oldpswd' AND user_id='$_SESSION[user_id]'";
...
<section id="contact" class="parallax-section" style="background-color:#CCF">
	<div class="container">
		<div class="row">
			<div class="col-md-offset-1 col-md-8 col-sm-12 text-center">
				<h1 class="heading">Change Password</h1>
				<hr>
			</div>
			<div class="col-md-offset-1 col-md-8 col-sm-11 wow fadeIn" data-wow-delay="0.9s">
